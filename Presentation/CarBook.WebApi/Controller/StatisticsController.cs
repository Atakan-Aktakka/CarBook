...
private readonly IMediator _mediator;
        ...
        {
            var values = await _mediator.Send(new GetAvgPriceForDailyQuery());
            return Ok(values);
        }
        ...
        {
            var values = await _mediator.Send(new GetAvgPriceForHourlyQuery());
            return Ok(values);
        }
        ...
        [HttpGet("GetCarCountByFuelHybrid")]
        public async Task<IActionResult> GetCarCountByFuelHybrid()
        {
            var values = await _mediator.Send(new GetCarCountByFuelHybridQuery());
            return Ok(values);
        }
        ...
        {
            var values = await _mediator.Send(new GetCarBrandAndModelByRentPriceDalyMaxQuery());
            return Ok(values);
        }
        ...
        {
            var values = await _mediator.Send(new GetCarBrandAndModelByRentPriceDalyMinQuery());
            return Ok(values);
        }
    }
}